...
<body class="bodyMargin">
	...
	<aside class="SelectedContent">
		<div class="proRequestBT">
							...
							<form method="post" action="./FollowEntfernen">
								<fieldset>
									<div>
										...
										<button class="classicBT" type="submit" id="button1">Nicht
											mehr Folgen</button>
									</div>
								</fieldset>
							</form>
			...
			<table>
				<c:forEach var="aktuelleFollowerOhneFollow"
					items="${followerOhneFollow}">
					<tr>
						<td><a class="textColor"
							...
							<form method="post" action="./FollowEntfernen">
								<fieldset>
									<div>
										...
										<button class="classicBT" type="submit" id="button2">Follower
											entfernen</button>
									</div>
								</fieldset>
							</form>
			...
			<table>
				<c:forEach var="aktuelleFollowerMitFollow"
					items="${followerMitFollow}">
					<tr>
						<td><a class="textColor"
							...
							<form method="post" action="./FollowEntfernen">
								<fieldset>
									<div>
										...
										<button class="classicBT" type="submit" id="button3">Follower
											entfernen</button>
									</div>
								</fieldset>
							</form>
								...
								<fieldset>
									<div>
										<input type="hidden" name="username2"
											value="${aktuelleFollowerMitFollow.username}">
										<button class="classicBT" type="submit" id="button4">Ebenfalls
											folgen</button>
									</div>
								</fieldset>
							</form>
